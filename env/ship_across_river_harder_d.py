...
class ShipAcrossRiverHarderD(core.Env):
    ...
    def _set_max_water_speed(self):
        ...
        :return:
        '''
        self.max_water_speed = 4 + 0. * np.random.standard_normal()
    ...
    def _cal_reward(self):
        ...
        # sub optimal is at position 50
            ...
            return self.sub_optimal_1_range - abs(self.y - self.sub_optimal_1_y), True
        # sub optimal is at position 80
        elif self.x >= self.max_x and abs(self.y - self.sub_optimal_2_y) <= self.sub_optimal_2_range:
            return (self.sub_optimal_2_range - abs(self.y - self.sub_optimal_2_y)) * 0.5, True
        # out of bounds
